...
All rights reserved.</p>
                 ...
                 <div className='col'>
                    <p>Company</p>
                    <a href='#' className='text-muted mt-4'>About</a><br/>
                    <a href='#'  className='text-muted mt-4'>Philosophy</a><br/>
                    <a href='#'  className='text-muted mt-4'>Press & media </a><br/>
                    <a href='#'  className='text-muted mt-4'>Careers</a><br/>
                   <a href='#'  className='text-muted mt-4'> Zerodha Cares (CSR)</a><br/>
                    <a href='#'  className='text-muted mt-4'>Zerodha.tech</a><br/>
                    <a href='#'  className='text-muted mt-4'>pen source</a><br/>
                    <a href='#'  className='text-muted mt-4'>Referral program</a><br/>
                 </div>
                  <div className='col'>
                    <p>Support</p>
                       <a href='#' className='text-muted mt-4'>Contact us</a><br/>
                    <a href='#' className='text-muted mt-4'>Support portal</a><br/>
                    <a href='#' className='text-muted mt-4'>How to file a complaint? </a><br/>
                    <a href='#' className='text-muted mt-4'>Status of your complaints</a><br/>
                   <a href='#' className='text-muted mt-4'> Bulletin</a><br/>
                    <a href='#' className='text-muted mt-4'>Circular</a><br/>
                    <a href='#' className='text-muted mt-4'>Z-Connect blog</a><br/>
                    <a href='#' className='text-muted mt-4'>Downloads</a><br/>
                  </div>
                   <div className='col'>
                    <p>Account</p>
                       <a href='# '  className='text-muted mt-4'>Open demat account</a><br/>
                    <a href='#' className='text-muted mt-4' >Minor demat account</a><br/>
                    <a href='#' className='text-muted mt-4' >NRI demat account </a><br/>
                    <a href='#' className='text-muted mt-4' >HUF demat account</a><br/>
                   <a href='#' className='text-muted mt-4'> Commodity</a><br/>
                    <a href='#' className='text-muted mt-4'>Dematerialisation</a><br/>
                    <a href='#' className='text-muted mt-4'>Fund transfer</a><br/>
                    <a href='#' className='text-muted mt-4'>MTF</a><br/>
                   </div>
            </div>
